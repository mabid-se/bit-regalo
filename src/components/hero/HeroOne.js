            ...
            <div className="welcome-content mb-5 mb-md-0">
              ...
              >
                <div className="hero-btn-group">
                  <Link
                    className={`btn btn-${buttonGroup[0].btnColor} rounded-pill mt-3 me-3`}
                    href={buttonGroup[0].btnURL}
                  >
                    {buttonGroup[0].btnText}
                    <i className={`ms-2 bi ${buttonGroup[0].btnIcon}`} />
                  </Link>
                  <Link
                    className={`btn btn-${buttonGroup[1].btnColor} hover-primary mt-3`}
                    href={buttonGroup[1].btnURL}
                  >
