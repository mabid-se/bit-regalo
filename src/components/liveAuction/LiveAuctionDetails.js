        ...
        <div className="card-body">
          ...
          <div className="row gx-2 align-items-center mt-2">
                ...
                <div className="name-author">
                  ...
                  >
                    <Link
                      ...
                      href={`${process.env.PUBLIC_URL}/live-bid/${elem.id}`}
                    >
                      {elem.title}
                    </Link>
                  </OverlayTrigger>
                  <Link
                    ...
                    href={`${process.env.PUBLIC_URL}/author/${elem.authorName}`}
                  >
                    @{elem.authorName}
                  </Link>
                </div>
            ...
            <div className="col-12">
              <Link
                className={`btn rounded-pill btn-sm mt-3 w-100  btn-yellow `}
                href={elem.buttonInfo[0].url}
              >
          ...
          <div className="row g-4 g-lg-5 align-items-center justify-content-center">
            ...
            <div className="col-12 col-md-12 col-lg-6">
              <div className="item-big-thumb">
                ...
                >
                  <img
                    src={`${process.env.PUBLIC_URL}/${bidsdata.image}`}
                    alt={bidsdata.title}
                  />
                </Zoom>
              </div>
            ...
            <div className="col-12 col-md-10 col-lg-6">
              <div className="item-details-content mt-5 mt-lg-0">
                ...
                {/* Dropdown */}
                <Dropdown
                  className={`section-${bidsdata.dropdownVisibility} item-details-dd`}
                >
                  <Dropdown.Toggle
                    className="rounded-pill shadow-sm p-0"
                    id={`itemDetailsID${bidsdata.id}`}
                  >
                    <i className="bi bi-three-dots-vertical" />
                  </Dropdown.Toggle>
                ...
                <div className="d-flex flex-wrap align-items-center">
                  {/* Wishlist */}
                  <button
                    className="btn btn-danger btn-sm rounded-pill px-3 wishlist-btn"
                    type="button"
                  >
                    <i className="bi" />
                    <span className="ms-1">{bidsdata.wishlistCount}</span>
                  </button>
                ...
                {/* Title */}
                <h2 className="my-3">{bidsdata.title}</h2>
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div className="author-img position-relative me-3">
                    ...
                    />
                    <i
                      className={`bi bi-check position-absolute bg-primary ${bidsdata.authorVerified}`}
                    />
                  </div>
                  ...
                  <div className="name-author">
                    ...
                    <Link
                      ...
                      href={`${process.env.PUBLIC_URL}/author/${bidsdata.authorName}`}
                    >
                      @{bidsdata.authorName}
                    </Link>
                  </div>
                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-6 col-sm-4 col-lg-5">
                    <Link
                      className={`btn   rounded-pill w-100  btn-yellow `}
                      href={bidsdata.buttonInfo[0].url}
                    >
                      <img
                        className="me-1"
                ...
                <div className="short-description">
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{
                      __html: bidsdata.shortDesc[0].body,
                    }}
                  ></p>
                </div>
              </div>
                  ...
                  <Tab eventKey="blockchain" title="Blockchain">
                    <Row>
                      <Col lg={7} style={{ color: "white" }}>
                        ...
                        >
                          {" "}
                          Escrow Contract issues on :
                        </span>{" "}
                        <span style={{ textDecoration: "underline" }}>
                          12/29/2023 -Wellington, New Zealand (UTC+13)
                        </span>
                        <br />
                        <span
                          style={{
                        ...
                        <span style={{ textDecoration: "underline" }}>
                          jhsdgjhg3874jhgfdkjsayfiuerdjf
                        </span>{" "}
                        <br /> <br />
                        <span
                          style={{
                        ...
                        <span style={{ textDecoration: "underline" }}>
                          jhfdka7asyfkasjhfjasf9348jd <br />
                        </span>{" "}
                        <span
                          style={{
                            color: "#F8FC2E",
                        ...
                        <span style={{ textDecoration: "underline" }}>
                          12/29/2023 -Wellington, New Zealand (UTC+13) <br />
                        </span>{" "}
                        <span
                          style={{
                            color: "#F8FC2E",
                      ...
                      <Col lg={2} style={{ color: "white" }}>
                        ...
                        <br />
                        jhgfjds87dfg87dfgdfjkgdfjk456hfg
                      </Col>
                    </Row>
                  </Tab>
                </Tabs>
