                ...
                <div className="name-author">
                  ...
                  >
                    <Link
                      ...
                      href={`${process.env.PUBLIC_URL}/discover-items/${elem.id}`}
                    >
                      {elem.title}
                    </Link>
                  </OverlayTrigger>
          ...
          <div className="row gx-2 align-items-center mt-3">
            <div className="col-6">
              <Link
                ...
                href={elem.buttonGroup[0].leftButtonURL}
              >
            ...
            <div className="col-6 text-end">
              <Link
                ...
                href={elem.buttonGroup[1].rightButtonURL}
              >
                <i
          ...
          <div className="row g-4 g-lg-5 align-items-center justify-content-center">
            ...
            <div className="col-12 col-md-12 col-lg-6">
              <div className="item-big-thumb">
                ...
                >
                  <img
                    src={`${process.env.PUBLIC_URL}/${discoverData.image}`}
              ...
              <div className="item-details-content mt-5 mt-lg-0">
                ...
                >
                  <Dropdown.Toggle
                    ...
                    id={`discoverDetailsID${discoverData.id}`}
                  >
                    <i className="bi bi-three-dots-vertical" />
                  </Dropdown.Toggle>
                ...
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  >
                    <i className="bi" />
                    <span className="ms-1">{discoverData.wishlistCount}</span>
                  </button>
                ...
                {/* Title */}
                <h2 className="my-3">{discoverData.title}</h2>
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div className="author-img position-relative me-3">
                    ...
                    />
                    <i
                      className={`bi bi-check position-absolute bg-primary ${discoverData.authorVerified}`}
                    />
                  </div>
                  ...
                  <div className="name-author">
                    ...
                    <Link
                      ...
                      href={`${process.env.PUBLIC_URL}/author/${discoverData.authorName}`}
                    >
                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-6 col-sm-4 col-lg-5">
                    <Link
                      className={`btn btn-${discoverData.buttonGroup[0].leftButtonStyle} rounded-pill w-100`}
                      href={discoverData.buttonGroup[0].leftButtonURL}
                    >
                      <img
                        className="me-1"
                ...
                <div className="short-description">
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{
                      __html: discoverData.shortDesc[0].body,
                    }}
                  ></p>
                </div>
              </div>
